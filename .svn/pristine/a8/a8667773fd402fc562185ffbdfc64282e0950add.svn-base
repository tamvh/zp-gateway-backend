 ...
 * @author haint3
 */
public class ZPGetTransactionStatusController extends HttpServlet {
    protected static final Logger logger = Logger.getLogger(ZPGetTransactionStatusController.class);
    ...
    private void processs(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        content = zpGatewayAPI.processGetTransactionStatus(paramMap);
