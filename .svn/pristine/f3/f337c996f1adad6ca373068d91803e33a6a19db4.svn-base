    ...
    function config($routeProvider, $locationProvider, $httpProvider) {
        $routeProvider
                ...
                .when('/changepassword', {
                    ...
                    templateUrl: 'change_password/change_password.view.html?v=' + posConfig.TEMPLATE_CHANGE_PASSWORD_VERSION
                })
                .when('/forgetpassword', {
                    controller: 'ForgetPasswordController',
                    templateUrl: 'forget_password/forget_password.view.html?v=' + posConfig.TEMPLATE_FORGET_PASSWORD_VERSION
                })
                .when('/resetpassword', {
                    controller: 'ResetPasswordController',
                    templateUrl: 'reset_password/reset_password.view.html?v=' + posConfig.TEMPLATE_RESET_PASSWORD_VERSION
                })
                .when('/reportbymonth/', {
