 ...
 * @author haint3
 */
public class ZPRefundController extends HttpServlet {
    protected static final Logger logger = Logger.getLogger(ZPRefundController.class);
    ...
    private void processs(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        content = zpGatewayAPI.processRefund(paramMap);
